...
##' Location: Hewatt transect, 0.5m
##' Logger serial: 04DF 7800 E606 09
...
# Get file names
files <- list.files(path = "data/04DF 7800 E606 09", pattern = "\\.csv")
files
...
# Already compiled from env_small (process_env_04EB240037540B.R)
d0 <- read_csv(here("data_output", "envlogger_04EB240037540B.csv"))
d0
d
